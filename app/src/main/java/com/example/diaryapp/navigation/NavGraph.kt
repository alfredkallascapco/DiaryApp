...
fun NavGraphBuilder.homeRoute(
    ...
    composable(route = Screen.Home.route) {
        ...
        var signedOutDialogOpened by remember {
        ...
        HomeScreen(
            ...
            onSignOutClicked = { signedOutDialogOpened = true },
            navigateToWrite = navigateToWrite
        )

        DisplayAlertDialog(
            title = "Sign out",
            message = "Are you sure you want to signout from your Google Account ?",
            dialogOpened = signedOutDialogOpened,
            onDialogClosed = { signedOutDialogOpened = false },
            onYesClicked = {
